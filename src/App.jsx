      ...
      <aside className={`sidebar ${navCollapsed?"collapsed":""}`}>
        ...
        <div className="sb-bot">
          <div className="sb-meta">
            <div className="org-user-chip" title={orgAccount?.username||""}>{orgAccount?.username||"Signed in"}</div>
          ...
          <button className="btn" onClick={signOutMicrosoft} disabled={orgAuthBusy} style={{marginTop:7}}>{orgAuthBusy?"Signing out...":"Sign out"}</button>
