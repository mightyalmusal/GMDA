...
var StringUtils = class {
  ...
  static matchPatternStrict(pattern, input, options) {
    const component = options == null ? void 0 : options.component;
...
function parseClientData(clientdata) {
  ...
  try {
    ...
    return {
      accountType: clientDataAccountTypeMapping.get(((_a = parts[0]) == null ? void 0 : _a.trim()) || "") || "",
      error: ((_b = parts[1]) == null ? void 0 : _b.trim()) || "",
      subError: ((_c = parts[2]) == null ? void 0 : _c.trim()) || "",
      cloudInstance: ((_d = parts[3]) == null ? void 0 : _d.trim()) || "",
      callerDataBoundary: ((_e = parts[4]) == null ? void 0 : _e.trim()) || ""
    };
  } catch {
    return null;
  }
...
function instrumentClientData(response, correlationId, performanceClient) {
  ...
  (parsed == null ? void 0 : parsed.accountType) && performanceClient.addFields({ accountType: parsed.accountType }, correlationId);
  (parsed == null ? void 0 : parsed.error) && performanceClient.addFields({ serverErrorNo: parsed.error }, correlationId);
  (parsed == null ? void 0 : parsed.subError) && performanceClient.addFields({ serverSubErrorNo: parsed.subError }, correlationId);
}
...
var PlatformAuthDOMHandler = class _PlatformAuthDOMHandler {
  ...
  getDOMExtraParams(extraParameters) {
    try {
      ...
      this.logger.errorPii(this.platformAuthType + " - Error stringifying extra parameters: " + e);
      return {};
    }
  }
};
...
var TokenCache = class {
  ...
  async loadExternalTokens(request, response, options) {
    ...
    try {
      ...
      const authority = await AuthorityFactory_exports.createDiscoveredInstance(Authority.generateAuthority(authorityString, request.azureCloudOptions), this.config.system.networkClient, this.storage, authorityOptions, this.logger, correlationId, this.performanceClient);
...
var StandardController = class _StandardController {
  ...
  acquireTokenPopup(request) {
    ...
    return result.then((result2) => {
      ...
      this.verifySsoCapability(result2.account, InteractionType.Popup);
      return result2;
    }).catch((e) => {
      if (loggedInAccounts.length > 0) {
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-UC5DWKHT.js");
    }
  } catch (e) {
  }
  return void 0;
